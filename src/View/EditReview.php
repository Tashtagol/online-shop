...
<style>
    ...
    .error-message { background-color:#ffe0e0;color:#d8000c;padding:12px 20px;border-radius:8px;margin-bottom:25px; }
    ...
    .form-group textarea { width:100%;padding:12px;border-radius:8px;border:1px solid #ccc;font-size:16px;outline:none;resize:vertical;min-height:100px; }
    .rating { display:flex;flex-direction:row-reverse;justify-content:flex-start;gap:5px; }
    .rating input[type="radio"] { display:none; }
    .rating label { font-size:36px;color:#ccc;cursor:pointer;transition:0.3s; }
    .rating label:hover,
    .rating label:hover ~ label,
    .rating input[type="radio"]:checked ~ label { color:#ffbc00;transform:scale(1.2); }
    button { width:100%;padding:14px;background-color:#ff7f50;color:white;font-size:18px;font-weight:600;border:none;border-radius:10px;cursor:pointer;transition:0.3s;margin-top:10px; }
    button:hover { background-color:#e26e47;transform:translateY(-2px); }
    .back-button { display:block;width:100%;margin-top:15px;padding:14px;text-align:center;background-color:#6c757d;color:white;font-size:18px;font-weight:600;border-radius:10px;text-decoration:none;transition:0.3s; }
    .back-button:hover { background-color:#5a6268;transform:translateY(-2px); }
    .orders-button { display:block;width:100%;margin-top:15px;padding:14px;text-align:center;background-color:#343a40;color:white;font-size:18px;font-weight:600;border-radius:10px;text-decoration:none;transition:0.3s; }
    .orders-button:hover { background-color:#23272b;transform:translateY(-2px); }
</style>