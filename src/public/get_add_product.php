...
<div class="container">
    ...
    <hr>
    <label for="name"><b>Product-id</b></label> <label style ="color: red">

        <?php echo $errors['product-id'] ?? ''; ?>  </label>
    <label for="name"></label><input type="text" placeholder="Enter product-id" name="product-id" id="product-id" required>

    <label for="Amount"><b>Amount</b></label>  <label style ="color: red">
